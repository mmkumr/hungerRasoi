...
Route::post('/payment', 'CheckoutController@payment')->name('checkout.store');
Route::post('/payment-data', 'CheckoutController@payment_online')->name('checkout.online');
...
Route::get('product', [RazorpayController::class, 'index'])->name('rpay');
